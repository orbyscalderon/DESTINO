...
import {
  ...
  FiSlash, FiBell, FiBellOff, FiRotateCw, FiClock, FiPin,
  FiCopy,
} from 'react-icons/fi';
          ...
          <div className="bg-dark-800 border-t border-white/5 px-4 py-3 shrink-0">
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex gap-2">
                ...
                >
                  <FiPin size={18} className={showPinInput || pinnedMessage ? 'text-brand-400' : 'text-white'} />
            ...
            {pinnedMessage && (
              ...
              >
                <div className="px-3 py-2 bg-brand-500/10 border-b border-brand-500/20 flex items-start gap-2">
                  <FiPin size={11} className="text-brand-400 shrink-0 mt-0.5" />
